...
import com.zhxu.storeapp.support.DensityUtil;
...
public class EnterLayout extends LinearLayout {
    ...
    private void a(Context context) {
        ...
        View localView = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.settings_enter_normal_item, this);
        item_layout = ((RelativeLayout) localView.findViewById(R.id.item_layout));
        ...
        devider_line = ((ImageView) localView.findViewById(R.id.devider_line));
    }
